...
config = { # Log hyperparameters
    ...
    "reward_line_clear_coeff": 500.0, # Example value, match below
    "penalty_height_increase_coeff": 7.5, # Example value, match below
    "penalty_hole_increase_coeff": 12.5, # Example value, match below
    "penalty_step_coeff": 0.0, # Example value, match below
    "penalty_game_over_coeff": 500.0 # Example value, match below
}
