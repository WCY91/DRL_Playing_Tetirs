...
vec_env = make_vec_env(TetrisEnv, n_envs=35, seed=123456789)
# Train the agent
model = PPO("CnnPolicy", vec_env, verbose=1, tensorboard_log="./sb3_log/",learning_rate=4e-4,n_steps=16,gae_lambda=0.95,gamma=0.97,ent_coef=0.006,vf_coef=0.7,normalize_advantage=True,max_grad_norm=0.7).learn(2800000)
...
with open('tetris_best_score_ppo.csv', 'w') as fs:
...
model.save('113598065_ppo_30env_1M.zip')
