...
config = { # Log hyperparameters
    ...
    "exploration_fraction": 0.3, # <<< INCREASED exploration duration
    ...
    "reward_line_clear_1_coeff": 1.0,    # NEW: Reward for clearing 1 line (adjust as needed)
    "reward_line_clear_2_coeff": 4.0,    # NEW: Reward for clearing 2 lines (adjust as needed)
    "reward_line_clear_3_coeff": 9.0,    # NEW: Reward for clearing 3 lines (adjust as needed)
    "reward_line_clear_4_coeff": 25.0,   # NEW: Reward for clearing 4+ lines (Tetris) (adjust as needed)
    "reward_drop_action_coeff": 0.1,     # NEW: Small reward for using the 'drop' action (adjust as needed)
    "penalty_height_increase_coeff": 7.5,
    "penalty_hole_increase_coeff": 12.5,
    "penalty_step_coeff": 0.0,          # Set to zero as per previous config
...
class TetrisEnv(gym.Env):
    ...
    def __init__(self, host_ip="127.0.0.1", host_port=10612, render_mode=None):
        ...
        self.reward_line_clear_1_coeff = current_config.get("reward_line_clear_1_coeff", 1.0)
        self.reward_line_clear_2_coeff = current_config.get("reward_line_clear_2_coeff", 4.0)
        self.reward_line_clear_3_coeff = current_config.get("reward_line_clear_3_coeff", 9.0)
        self.reward_line_clear_4_coeff = current_config.get("reward_line_clear_4_coeff", 25.0) # Tetris bonus
